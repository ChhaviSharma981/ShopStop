...
class SellerAddProduct extends React.Component {
    ...
    async componentDidMount() {
        this.setState({ category: await this.getAllcategory() });
    }
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className='col-8 offset-1'>
                            <center>
                                <h1 className='mt-4' style={{ fontWeight: "bold" }}>Add Product</h1>
                            </center>
                            <form>
                                <div className="mb-3">
                                    <label className="form-label">Product Name</label>
                                    <input type="text" class="form-control" id="text" required onChange={(e) => this.setState({ name: e.target.value })} />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">Product description</label>
                                    <textarea name="description" className='form-control' id="" cols="30" rows="5" onChange={(e) => this.setState({ descrption: e.target.value })}></textarea>
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">Quantity</label>
                                    <input type="number" class="form-control" id="text" placeholder="0" required onChange={(e) => this.setState({ qty: e.target.value })} />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">Per Price</label>
                                    <input type="number" class="form-control" id="text" required onChange={(e) => this.setState({ price: e.target.value })} />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">Product Image Link</label>
                                    <input type="text" class="form-control" id="text" required onChange={(e) => this.setState({ image: e.target.value })} />
                                </div>
                                <div className="mb-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <select name="status" className='form-control' id="" onChange={(e) => this.setState({ cato: e.target.value })}>
                                        {this.state.category.map((cato) => (
                                            <option value={cato.name}>{cato.name}</option>
                                        ))}
                                    </select>
                                </div>
                                <div className="mb-3">
                                ...
                                <br />
                                <button type="button" className='btn btn-primary col-12' onClick={async () => { await this.addProduct(); }}>ADD</button>
                                <br></br>
